...
export const scenarios = [
  ...
  },
  {
    ...
    However, just as you begin to grasp the fundamentals of the controls, a sudden surge of energy pulses through the console, illuminating the chamber in a blinding flash of light. Alarms blare, echoing through the chamber as the time machine's systems spring to life, indicating an imminent temporal jump.
